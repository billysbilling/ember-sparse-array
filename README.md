# Ember.js Sparse Array [![Build Status](https://travis-ci.org/billysbilling/ember-sparse-array.svg?branch=master)](https://travis-ci.org/billysbilling/ember-sparse-array)
